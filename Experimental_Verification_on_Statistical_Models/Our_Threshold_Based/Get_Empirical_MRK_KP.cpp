...
int main(int argc, char * argv[])
{
	...
	double determin_point_1[2];
	for(int i=0;i<2;i++)
	{
		determin_point_1[i]=(KeyClass_1[i]+KeyClass_1[i+1])/2.0;
	}
	cout<<"determin_point_1:"<<endl;
	for(int i=0;i<2;i++)
	{
		cout<<determin_point_1[i]<<" ";
	}
	cout<<endl;
	
	double determin_point_2[3];
	for(int i=0;i<3;i++)
	{
		determin_point_2[i]=(KeyClass_2[i]+KeyClass_2[i+1])/2.0;
	}
	cout<<"determin_point_2:"<<endl;
	for(int i=0;i<3;i++)
	{
		cout<<determin_point_2[i]<<" ";
	}
	cout<<endl;
	
	double determin_point_3[2];
	for(int i=0;i<2;i++)
	{
		determin_point_3[i]=(KeyClass_3[i]+KeyClass_3[i+1])/2.0;
	}
	cout<<"determin_point_3:"<<endl;
	for(int i=0;i<2;i++)
	{
		cout<<determin_point_3[i]<<" ";
	}
	cout<<endl;
	...
	for(int test_num=0;test_num<TotalTestNum;test_num++)
	{
		...
		testCor=pow(2,11-IterativeNum)*(counter_K1-counter_K2);
		determined_index_1=0;
		if(testCor<=determin_point_1[0])
		{
			determined_index_1=0;
		}
		else
		{
			if(testCor<=determin_point_1[1])
			{
				determined_index_1=1;
			}
			else
			{
				determined_index_1=2;
			}
		}
		...
		if(theory_index_1==determined_index_1)
		{
			...
			//make desicion according to the counter
			testCor=pow(2,11-IterativeNum)*(counter_K1-counter_K3);
			determined_index_2=0;
			if(testCor<=determin_point_2[0])
			{
				determined_index_2=0;
			}
			else
			{
				if(testCor<=determin_point_2[1])
				{
					determined_index_2=1;
				}
				else
				{
					if(testCor<=determin_point_2[2])
					{
						determined_index_2=2;
					}
					else
					{
						determined_index_2=3;
					}
				}
			}
			if(theory_index_2==determined_index_2)
			{
				...
				//make desicion according to the counter
				testCor=pow(2,11-IterativeNum)*(counter_K1-counter_K4);
				determined_index_3=0;
				if(testCor<=determin_point_3[0])
				{
					determined_index_3=0;
				}
				else
				{
					if(testCor<=determin_point_3[1])
					{
						determined_index_3=1;
					}
					else
					{
						determined_index_3=2;
					}
				}
