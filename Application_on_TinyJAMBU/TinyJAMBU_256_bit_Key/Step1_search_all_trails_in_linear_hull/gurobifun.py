'''
	This code was provided as one of source codes of the paper "On the Security Margin of TinyJAMBU with Refined Differential and Linear Cryptanalysis".
'''
...
def and_variables(mod, a, b, c):
	'''Returns c=a&b
	'''
	mod.addConstr(c >= 0)
	mod.addConstr(a >= c)
	mod.addConstr(b >= c)
	mod.addConstr(a+b <= c+1)
